...
ui <- navbarPage(
  ...
  tabPanel(
    ...
    fluidRow(
      column(width = 8,
             box(width = 12,
                 "This dashboard has been produced by professionals with experience in data visualization and scenario planning for public policy analysis and decision making.", em(strong("We do not have medical expertise or formal training in epidemiology.")), "The information provided here is based solely on a mathematical analysis of data from other sources, and", em(strong("is not intended to replace or supersede authoritative information from any official or medical source.")), br(),
                 br(),
